...
class BufannaoCms_Plugin implements Typecho_Plugin_Interface
{
    ...
    {
		echo '<li>';
		echo '<p><strong>适用bufannaoCms相关功能的文章，必须严格按照下面的规则命名缩略名：</strong></p>';
		echo '<p class="description">通用规则：缩略名以【__】开头</p>';
		echo '<p class="description">幻灯功能：缩略名包含【slide__】</p>';
		echo '<p class="description">推荐文章：缩略名包含【top__】</p>';
		echo '<p class="description">相册文章：缩略名包含【album__】</p>';
		echo '<p class="description">【上述“__”均为两个下划线】</p>';
		echo '</li>';
		return '';
	}
