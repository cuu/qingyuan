<div id="comments">
	...
	<div class="respond" id="<?php $this->respondId(); ?>">
		...
		<h4><?php _e('Post a new comment'); ?> </h4>
			...
			<?php else: ?>
				<div class="clearfix">
					...
					<p class="comment-cloumn"><label for="url"><?php _e('Website (optional)'); ?></label><input type="url" name="url" id="url" class="text" value="<?php $this->remember('url'); ?>" /></p>
				</div>
			<?php endif; ?>
