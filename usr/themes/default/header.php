...
<div id="header" class="container_16 clearfix">
	...
	<div id="splash">
		<?php if($this->options->splashUrl): ?>
		<img src="<?php $this->options->splashUrl() ?>" alt="<?php $this->options->title()  ?>" />
		<?php endif; ?>
	</div>
	<div id="logo">
	    ...
	    <p class="description" style="font-size:12px;"><?php $this->options->description() ?></p>
    </div>
</div><!-- end #header -->
